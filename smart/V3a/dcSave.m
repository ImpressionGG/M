...
% FIXME   savedata(fout,format(obj),'format');
   fprintf(fout,'\n');
% FIXME   savedata(fout,get(obj),'parameter')
   fprintf(fout,'\n');
% FIXME   savedata(fout,data(obj),'data')
   fprintf(fout,'\n');
