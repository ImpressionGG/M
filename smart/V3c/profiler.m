...
%               profiler('sub1',-1)     % end profiling
%               profiler('sub2',1)      % begin profiling
%               profiler('sub2',-1)     % end profiling
...
%    end
   if isfield(x,name),
     x.(name)=0;
      ...
      error('arg2 (%s) must be compliant with identifier syntax!',name);
   end
...
%
   ...
   profile(smart,'main',0);     % reset & begin profiling main
   profile(smart,'sub1',1);     % begin profiling sub1
   profile(smart,'sub1',-1);    % end profiling sub1
   profile(smart,'sub2',1);     % begin profiling sub1
   profile(smart,'sub2',-1);    % end profiling sub1
   profile(smart,'main',-1);    % reset & begin profiling main
