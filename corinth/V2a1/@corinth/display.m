...
function str = OldPolyString(o,poly,sym)    % Readable String for Poly 
%
...
function str = OldRatioString(o,num,den,sym)% Readable String for Poly 
%
...
%
   ...
   if isequal(poly,vpa(0))             % special: 0
      str = '0';
      return                           % we can handle quickly: bye!
   elseif isequal(poly,vpa(1))         % special: 1
      str = '1';
      return                           % we can handle quickly: bye!
   elseif isequal(poly,vpa(-1))        % special: -1
      str = '-1';
