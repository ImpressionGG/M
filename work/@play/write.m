function oo = write(o,varargin)        % Write PLAY Object To File
%
% WRITE   Write driver to write a PLAY object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: PLAY, EXPORT
%
...
%==========================================================================
% Data Write Driver for Play Stuff
%==========================================================================
