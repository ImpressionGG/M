function oo = new(o,varargin)          % PLAY New Method              
%
% NEW   New PLAY object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(play,'Simple')    % some simple data
%           o = new(play,'Wave')      % some wave data
%           o = new(play,'Beat')      % some beat data
%
%       See also: PLAY, PLOT, ANALYSIS, STUDY
%
