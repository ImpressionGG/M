function oo = shell(o,varargin)        % PLAY shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Play Shell');
   o = provide(o,'par.comment',{'Playing around with PLAY objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Play');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@play});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Play');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@play});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'play/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'play/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'play/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'play/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Play Class: Version ',version(play)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit play/version');

   plugin(o,'play/shell/Info');       % plug point
end
