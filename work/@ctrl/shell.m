function oo = shell(o,varargin)        % CTRL shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Ctrl Shell');
   o = provide(o,'par.comment',{'Playing around with CTRL objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Ctrl');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@ctrl});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Ctrl');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@ctrl});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'ctrl/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'ctrl/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'ctrl/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'ctrl/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Ctrl Class: Version ',version(ctrl)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit ctrl/version');

   plugin(o,'ctrl/shell/Info');       % plug point
end
