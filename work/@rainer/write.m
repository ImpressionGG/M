function oo = write(o,varargin)        % Write RAINER Object To File
%
% WRITE   Write driver to write a RAINER object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: RAINER, EXPORT
%
...
%==========================================================================
% Data Write Driver for Rainer Stuff
%==========================================================================
