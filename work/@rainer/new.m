function oo = new(o,varargin)          % RAINER New Method              
%
% NEW   New RAINER object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(rainer,'Simple')    % some simple data
%           o = new(rainer,'Wave')      % some wave data
%           o = new(rainer,'Beat')      % some beat data
%
%       See also: RAINER, PLOT, ANALYSIS, STUDY
%
...
function oo = Wave(o)                  % New wave object
   ...
   oo = rainer('alt');                  % alternative type
