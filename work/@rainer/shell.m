function oo = shell(o,varargin)        % RAINER shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Rainer Shell');
   o = provide(o,'par.comment',{'Playing around with RAINER objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Rainer');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@rainer});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Rainer');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@rainer});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'rainer/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'rainer/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'rainer/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'rainer/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Rainer Class: Version ',version(rainer)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit rainer/version');

   plugin(o,'rainer/shell/Info');       % plug point
end
