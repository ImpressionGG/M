function oo = shell(o,varargin)        % TEST2 shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Test2 Shell');
   o = provide(o,'par.comment',{'Playing around with TEST2 objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Test2');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@test2});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Test2');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@test2});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'test2/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'test2/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'test2/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'test2/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Test2 Class: Version ',version(test2)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit test2/version');

   plugin(o,'test2/shell/Info');       % plug point
end
