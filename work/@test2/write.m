function oo = write(o,varargin)        % Write TEST2 Object To File
%
% WRITE   Write driver to write a TEST2 object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: TEST2, EXPORT
%
...
%==========================================================================
% Data Write Driver for Test2 Stuff
%==========================================================================
