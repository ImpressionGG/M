function oo = new(o,varargin)          % TEST2 New Method              
%
% NEW   New TEST2 object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(test2,'Simple')    % some simple data
%           o = new(test2,'Wave')      % some wave data
%           o = new(test2,'Beat')      % some beat data
%
%       See also: TEST2, PLOT, ANALYSIS, STUDY
%
