function oo = write(o,varargin)        % Write TEST3 Object To File
%
% WRITE   Write driver to write a TEST3 object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: TEST3, EXPORT
%
...
%==========================================================================
% Data Write Driver for Test3 Stuff
%==========================================================================
