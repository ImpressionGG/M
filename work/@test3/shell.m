function oo = shell(o,varargin)        % TEST3 shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Test3 Shell');
   o = provide(o,'par.comment',{'Playing around with TEST3 objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Test3');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@test3});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Test3');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@test3});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'test3/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'test3/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'test3/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'test3/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Test3 Class: Version ',version(test3)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit test3/version');

   plugin(o,'test3/shell/Info');       % plug point
end
