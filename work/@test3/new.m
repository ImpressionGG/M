function oo = new(o,varargin)          % TEST3 New Method              
%
% NEW   New TEST3 object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(test3,'Simple')    % some simple data
%           o = new(test3,'Wave')      % some wave data
%           o = new(test3,'Beat')      % some beat data
%
%       See also: TEST3, PLOT, ANALYSIS, STUDY
%
