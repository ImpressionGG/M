function oo = write(o,varargin)        % Write TEST5 Object To File
%
% WRITE   Write driver to write a TEST5 object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: TEST5, EXPORT
%
...
%==========================================================================
% Data Write Driver for Test5 Stuff
%==========================================================================
