function oo = shell(o,varargin)        % TEST5 shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Test5 Shell');
   o = provide(o,'par.comment',{'Playing around with TEST5 objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Test5');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@test5});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Test5');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@test5});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'test5/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'test5/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'test5/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'test5/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Test5 Class: Version ',version(test5)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit test5/version');

   plugin(o,'test5/shell/Info');       % plug point
end
