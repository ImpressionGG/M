function oo = write(o,varargin)        % Write TEST4 Object To File
%
% WRITE   Write driver to write a TEST4 object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: TEST4, EXPORT
%
...
%==========================================================================
% Data Write Driver for Test4 Stuff
%==========================================================================
