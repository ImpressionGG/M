function oo = shell(o,varargin)        % TEST4 shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Test4 Shell');
   o = provide(o,'par.comment',{'Playing around with TEST4 objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Test4');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@test4});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Test4');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@test4});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'test4/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'test4/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'test4/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'test4/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Test4 Class: Version ',version(test4)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit test4/version');

   plugin(o,'test4/shell/Info');       % plug point
end
