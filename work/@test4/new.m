function oo = new(o,varargin)          % TEST4 New Method              
%
% NEW   New TEST4 object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(test4,'Simple')    % some simple data
%           o = new(test4,'Wave')      % some wave data
%           o = new(test4,'Beat')      % some beat data
%
%       See also: TEST4, PLOT, ANALYSIS, STUDY
%
