...
%
% OPTION   Get or set figure/menu options of current figure.
%
%    While these options are stored in the figure's user data, a copy of
%    the options is pushed into the SMART object's parameters and is
%    permanent accesible during the life time of a figure/menu callback.
%         
