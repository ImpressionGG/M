...
%
% DEFAULT   Provide a default setting for current figure.
%
%    1) These settings are stored as a structure in figure's user data. 
%         
...
%    def.filter = 9;                  % filter mode = 9 (forward/backward o1) 
