function oo = write(o,varargin)        % Write ECOS Object To File
%
% WRITE   Write driver to write a ECOS object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: ECOS, EXPORT
%
...
%==========================================================================
% Data Write Driver for Ecos Stuff
%==========================================================================
