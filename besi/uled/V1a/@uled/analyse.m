...
function oo = Parameter(o)
   setting(o,'analyse.na',4);          % number of arm
   setting(o,'analyse.nb',2);          % number of bond heads per arm
   
   oo = mitem(o,'Parameter');
   ooo = mitem(oo,'Number of Arms (na)',{},'analyse.na');
   charm(ooo,{});
   ooo = mitem(oo,'Number of Bond Heads per Arm (nb)',{},'analyse.nb');
   charm(ooo,{});
end
