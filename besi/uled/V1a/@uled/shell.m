function oo = shell(o,varargin)        % ULED shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Uled Shell');
   o = provide(o,'par.comment',{'Playing around with ULED objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Uled');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@uled});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Uled');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@uled});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'uled/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'uled/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'uled/shell/Analyse');    % plug point
end
...
function oo = Study(o)                 % Study Menu
   ...
   plugin(o,'uled/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Uled Class: Version ',version(uled)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit uled/version');

   plugin(o,'uled/shell/Info');       % plug point
end
