...
%
   ...
   while (control(smart))
      ...
      wing(obj,fac*psi0,z,'r',tp,np); 
      wing(obj,fac*psi1,z,'y',tp,np); 
      wing(obj,fac*psi,z,'b',tp,np); 
      balley(obj,fac/2*P,z,'g',1.0); 
...
%
   ...
   while (control(smart))
      ...
      wing(obj,fac*psi0,z,'r',tp,np); 
      wing(obj,fac*psi1,z,'y',tp,np); 
      wing(obj,fac*psi2,z,'m',tp,np); 
      wing(obj,fac*psi,z,'d',tp,np); 
      balley(obj,fac/2*P,z,'g',1.0); 
...
%
   ...
   omega = 1;
   z = -10:0.05:10;                          % our coordinate space
   ...
   while (control(smart))
      ...
      wing(obj,fac*psiN,z,colw,tp,np,np,0.1); 
      balley(obj,fac/2*P,z,colb,trsp); 
