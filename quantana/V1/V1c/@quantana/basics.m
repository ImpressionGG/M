...
%
   ...
   while (control(smart))
      ...
      wing(obj,fac*psi1,z,'r',tp,np); 
      wing(obj,fac*psi2,z,'y',tp,np); 
      wing(obj,fac*psi,z,'b',tp,np); 
      balley(obj,fac*P,z,'g',1.0); 
...
%
   ...
   while (control(smart))
      ...
      pale(obj,fac*psi1,z,'r',tp,mp,np); 
      pale(obj,fac*psi2,z,'y',tp,mp,np); 
      pale(obj,fac*psi,z,'b',tp,mp,np); 
      balley(obj,fac*P,z,'g',1.0); 
