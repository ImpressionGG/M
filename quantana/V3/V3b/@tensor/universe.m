...
%            Object is implemented as tensor object, format '#UNIVERSE'.
%
%               H = space(tensor,1:5);
...
%               U = universe(Y);
%
%            See also: TENSOR, SPACE, SPLIT, HISTORY
%
   if (nargin == 1)
      ...
      uni = format(obj,'#UNIVERSE');   % convert obj to universe
