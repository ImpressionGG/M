function oo = harmosc(o,varargin)      % Harmonic Oscillator Menu      
%
% HARMOSC   Harmonic Oscillator Menu
%
%           Topics
%             - eigen functions
%             - eigen oscillations
%             - coherent state
%
   [gamma,oo] = manage(o,varargin,@Setup,@EnergyLevels,@EigenFuncs,...
                      @EigenOscis);
...
function o = EigenFuncs(o)             % Plot Eigen Functions          
%
...
function o = EigenOscis(o)             % Plot Eigen Oscillations       
%
...
function OldCbEnergyLevels(obj)
%
% ENERGYLEVELS  Plot energy levels of harmonic oscillator
%
   cls(obj);
...
function o = CbPulseAnalysis(obj)      % Pulse Analysis                
%
...
function o = CbHarmonicField(o)        % Harmonic Field                
%
...
function o = CbHarmonicAnalysis(o)     % harmonic Analysis             
%
...
function o = HarmonicExcitation(o)     % harmonic Excitation           
%
% HARMONIC-EXCITATION
%
