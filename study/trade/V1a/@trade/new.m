...
%
% NEW   New TRADE object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(trade,'Simple')    % some simple data
%           o = new(trade,'Wave')      % some wave data
%           o = new(trade,'Beat')      % some beat data
%
%       See also: TRADE, PLOT, ANALYSIS, STUDY
%
