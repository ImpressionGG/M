...
%
%               H = toy('spin');        % 2D spin space
%               H = toy('twin');        % 2 entangled spins
%               H = toy('triple');      % 3 entangled spins
%               H = toy('alpha');       % alpha decay toy model
%               H = toy('detector');    % simple detector toy model
%
...
%
   ...
   switch arg
      ...
      case {'twin2121','twin'}            % entangeled spins
         Hs = space('spin');              % spin space A (column)
         H = SetupTwin(Hs,Hs);
