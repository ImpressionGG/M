...
%    by the CORE class. The other two settings 'color' and 'bullets' are
...
%
%    2) Select a color (Play/Color). You will see that the check mark,
%    which is initially with menu item 'Red', moves to the selected color
%
