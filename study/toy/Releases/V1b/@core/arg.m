...
%       obj = set(obj,'arg',{})           % synonym for above
%
%       obj = arg(obj,{'abc',pi})         % set arg list with 2 arguments
%       obj = set(obj,'arg',{'abc',pi})   % synonym for above
%
%    Get arguments
%
...
%       arglist = arg(obj);
%
%    There is a special powerful calling syntax for ARG:
%
...
%
   if (nargout <= 1 && nargin == 1)      % calling syntax is obsolete

      fprintf('*** arg: obsolete calling syntax: value = arg(obj)');
      value = get(obj,'arg');
      
   elseif (nargout > 1 && nargin == 1)   % powerful calling syntax
   ...
   elseif (nargout <= 1 && nargin == 3)
      ...
      fprintf('*** obsolete calling syntax: obj = arg(obj,[],value)');
