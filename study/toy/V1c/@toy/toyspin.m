function toyspin(obj,varargin)
% 
% TOYSPIN   Spin space demos (from Susskind's theoretical minimum)
%
%    Setup demo menu & handle menu callbacks of user defined menu items
%    The function needs creation and setup of a chameo object:
%
%       toyspin(toy)              % open menu and add demo menus
%       toyspin(toy,'Setup')      % add demo menus to existing menu
%       toyspin(toy,func)         % handle callbacks
%
