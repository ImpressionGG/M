...
%  oo = Analysis(o);                   % add Analysis menu
   oo = SunClock(o);                   % setup SunClock menu
...
function o = Init(o)                   % Init Object                   
   ...
   o = provide(o,'par.title','Kalman Shell');
   o = provide(o,'par.comment',{'Playing around with Kalman objects'});
...
function oo = SunClock(o)              % Scenario Menu                 
   oo = mhead(o,'Sun Clock');          % add roll down header menu item
   dynamic(oo);                        % make this a dynamic menu
   ooo = sunclock(oo,'Menu');          % setup Parameter menu
end
...
function oo = Info(o)                  % Info Menu                     
   ...
   oooo = mitem(ooo,['Kalman Class: Version ',version(kalman)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit kalman/version');
end
