function oo = write(o,varargin)        % Write MESH Object To File
%
% WRITE   Write driver to write a MESH object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: MESH, EXPORT
%
...
%==========================================================================
% Data Write Driver for Mesh Stuff
%==========================================================================
