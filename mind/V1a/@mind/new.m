function oo = new(o,varargin)          % MIND New Method              
%
% NEW   New MIND object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(mind,'Simple')    % some simple data
%           o = new(mind,'Wave')      % some wave data
%           o = new(mind,'Beat')      % some beat data
%
%       See also: MIND, PLOT, ANALYSIS, STUDY
%
