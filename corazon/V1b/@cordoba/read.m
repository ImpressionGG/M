function oo = read(o,varargin)         % Read CORDOBA Object From File 
%
% READ   Read a CORDOBA object from file.
%
...
%
   ...
   oo = cordoba('list');               % create a container object
