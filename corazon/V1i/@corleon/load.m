%
% LOAD   Load an object from a CORLEON .MAT file
%
%    An class object which has been saved previously to a CORLEON type .MAT
...
%       object = load(o,'o.mat')       % load object from ./o.mat
%
%    It is also to return the saved CORLEON query object (o):
%
%       [object,o] = load(o,filepath)  % load object & CORLEON query object
%
...
%    Example 1:
%
%       quo = query(object);           % generate a CORLEON query object
...
%          if exist('corleon') == 2   % corleon toolbox accessible
%             [Object,qo] = load(corleon,filepath);
