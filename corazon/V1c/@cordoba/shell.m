function oo = shell(o,varargin)        % CORDOBA shell                 
%
% SHELL   CORDOBA Shell
%
%            shell(cordoba)            % open CORDOBA shell
%
...
function o = Init(o)                   % Init Object                   
   o = menu(o,'Default');              % provide CORDOBA defaults
...
function o = Register(o)               % Register Plugins              
   ...
   plugin(o,'cordoba/shell/Register');% plug point
   rebuild(o);
end
...
function oo = File(o)                  % File Menu                     
   ...
   plugin(oo,'cordoba/shell/File');    % plug point
end
function oo = New(o)                   % New Menu Items                
   oo = menu(o,'New');                 % add CORDOBA New menu
   ooo = mitem(oo,'Stuff');
   oooo = shell(ooo,'Stuff','weird');
   oooo = shell(ooo,'Stuff','ball');
   oooo = shell(ooo,'Stuff','cube');
   plugin(oo,'cordoba/shell/New');     % plug point
end
function oo = Import(o)                % Import Menu Items             
   ...
   oooo = mitem(ooo,'General Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@cordoba});
   oooo = mitem(ooo,'Package Info (.pkg)',{@ImportCb,'ReadPkgPkg','.pkg',@cordoba});

   ooo = mitem(oo,'Stuff');
   oooo = mitem(ooo,'Text File (.txt)',{@ImportCb,'ReadStuffTxt','.txt',@corazon});
   plugin(oo,'cordoba/shell/Import');  % plug point
   return
...
function oo = Export(o)                % Export Menu Items             
   ...
   oooo = mitem(ooo,'Package Info (.pkg)',{@ExportCb,'WritePkgPkg','.pkg',@cordoba});
   ...
   plugin(oo,'cordoba/shell/Export');  % plug point
   return
...
function oo = Collect(o)               % Configure Collection          
   ...
   plugin(o,'cordoba/shell/Collect');  % plug point
   
   if isequal(class(o),'cordoba')
...
function oo = Edit(o)                  % Edit Menu                     
   ...
   plugin(oo,'cordoba/shell/Edit');    % plug point
end
...
function oo = View(o)                  % View Menu                     
   ...
   plugin(ooo,'cordoba/shell/Style');  % plug point
   ooo = wrap(oo,'Signal');            % Wrap Signal Menu
   plugin(oo,'cordoba/shell/View');    % plug point
end
...
%
   ...
   plugin(oo,'cordoba/shell/Signal');  % plug point
...
function oo = Select(o)                % Select Menu                   
   ...
   plugin(oo,'cordoba/shell/Select');  % plug point
end
...
function oo = Plot(o)                  % Plot Menu                     
   if isequal(o.type,'weird')
      ...
      ooo = menu(oo,'Plot');           % delegate to menu@cordoba>Plot
   end
   plugin(oo,'cordoba/shell/Plot');    % plug point
end
...
function oo = Analysis(o)              % Analysis Menu                 
   ...
   plugin(oo,'cordoba/shell/Analysis');% plug point
end
...
function oo = Study(o)                 % Study Menu                    
   ...
   plugin(oo,'cordoba/shell/Study');   % plug point
end
...
function oo = Plugin(o)                % Plugin Menu                   
   ...
   oo = plugin(oo,'cordoba/shell/Plugin');
end
...
function oo = Gallery(o)               % Gallery Menu                  
   ...
   plugin(oo,'cordoba/shell/Gallery'); % plug point
end
...
function oo = Info(o)                  % Info Menu                     
   ...
   oooo = mitem(ooo,['Cordoba Class: Version ',version(cordoba)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit espresso/version');
   plugin(oo,'cordoba/shell/Info');    % plug point
end
...
function oo = Figure(o)                % Figure Menu                   
   ...
   plugin(oo,'cordoba/shell/Figure');  % plug point
end
