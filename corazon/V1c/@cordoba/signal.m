...
%
%             cfg = 't,x[�]:r,y[�]:b'; % configuration string 
...
%
%          See also: CORDOBA, CONFIG, CATEGORY, SUBPLOT
%
...
%
   ...
   %
   % XYTh Setup for red x[�], blue y[�], green th[m�]
   %      spec limits -2�...2� for x,y and -20...20m� for th
   %
      o = category(o,1,[-2 2],[],'�')
      o = category(o,2,[-20 20],[],'m�')
...
function Display(o)                    % Display Signal Options        
   ...
   for (k = 1:length(types))
      type = types{k};
      oo = cordoba(type);              % working object
