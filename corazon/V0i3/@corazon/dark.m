...
%
%           oo = dark(o,0);            % set dark mode options => bright
%           oo = dark(o,1);            % set dark mode options => dark
%
...
%
   if (nargin == 2 && (isa(mode,'double') || isa(mode,'logical')))
      ...
      if (nargout == 0)
         control(o,'dark',mode);          % set dark mode
         control(o,'color',col);          % set background color
      else
         o = control(o,'dark',mode);      % set dark mode
         o = control(o,'color',col);      % set background color
         mode = o;
      end
      return
