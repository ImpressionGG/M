...
%
%     Alternatively an object and index into shell's children list can be
%     retrieved for a given object ID (index = 0 for schell object)
%
%        ID = id(cuo)
%        [oo,idx] = id(o,ID)         % object & index with given object ID
%
...
function [oo,idx] = Object(o,ID)       % Identify Object               
   ...
   for (i=1:length(o.data))
      ...
      % object not found with corresponding ID
