...
%
   [gammas,oos] = Event(o,varargin);   % pass to Event work horse
      ...
      % if effective Nargin == 3 (lenth(varargin)==2) the Event work horse
      % does a pure registering job of the event and gammas = [] is retur-
      % ned, which means we are done! Otherwise gammas is a table of func-
      % tion callbacks which we have to execute!
