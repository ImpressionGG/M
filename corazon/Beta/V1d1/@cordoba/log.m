...
%    data logging object.
%
%       oo = log(cordoba,'t','x','y','z',...)    % init a data log object
...
%
%       oo = log(cordoba,'t,x,y,z');
%       oo = log(cordoba,'t',0:100,'x,y,z',rand(3,101));
%       oo = log(cordoba,'t',0:100,'x,y,z',rand(m*3,101));
%       oo = log(cordoba,'t,x,y,z',0:100,rand(m*3,101));
%       oo = log(cordoba,'t,x,y,z',0:100,rand(m*3,101));
%
%       oo = log(cordoba,'t[s],x[�]:r#1,y[�]#2,th[m�]@g',rand(1+m*3,n));
%
...
%
%    See also: CORDOBA, TRACE, PLOT, LABEL, CONFIG, CATEGORY, SUBPLOT
%
