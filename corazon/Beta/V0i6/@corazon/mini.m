function oo = mini(o,varargin)         % Mini Shell for CORAZON Class  
% 
% MINI   Open new figure and setup a mini menu for a CORAZON object
%      
%           o = corazon      % create a CORAZON object
%           mini(o)          % open a CORAZON mini shell
%
...
function o = Init(o)                   % Init Object                   
   if isempty(get(o,'title')) && container(o)
      ...
      o = set(o,'title','Corazon Mini Shell');
      o = set(o,'comment',{'a mini shell for Corazon objects'});
   end
...
function oo = New(o)                   % New Menu Items                
   ...
   oo = shell(corazon(o),'New',types); % add New menu items @ Carbao shell
end
