...
%
%    See also: CORDOBA, SHELL, ADVANCED
%
...
function oo = PackageInfo(o)           % Provide Package Info File     
   ...
   oo.par.version = ['corazon ',version(o)];
...
%
   o = cast(o,'cordoba');              % cast to cordoba object
   oo = plot(o,'Setup');               % setup Plot menu
end
function o = PlotCb(o)                 % Plot Callback                 
   fprintf('*** warning: cordoba/menu/PlotCb() will be obsoleted!\n');
   args = arg(o);                      % get args
   o = arg(o,[{'Plot'},args]);         % expand arg list with 'Plot' head
   o = cast(o,'cordoba');              % cast to cordoba object
   o = plot(o);                        % redirect to cordoba/plot/Plot
   return
   
   refresh(o,o);                       % setup callback for refresh
   if isa(o,'cordoba')
      args = arg(o,0);                 % save args
      o = arg(pull(cordoba),args);     % restore args to pulled object
   end
