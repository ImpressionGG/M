...
%
%           o = new(pll,'Simple')    % some simple data
%           o = new(pll,'Wave')      % some wave data
%           o = new(pll,'Beat')      % some beat data
%
%       See also: PLL, PLOT, ANALYSIS, STUDY
%
