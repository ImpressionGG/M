...
%
% NEW   New SURGE object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(surge,'Simple')    % some simple data
%           o = new(surge,'Wave')      % some wave data
%           o = new(surge,'Beat')      % some beat data
%
%       See also: SURGE, PLOT, ANALYSIS, STUDY
%
