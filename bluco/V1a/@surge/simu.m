...
function oo = TvsMenu(o)                                               
   ...
   oo = mitem(o,'TVS Diode',{},'TVS');
        choice(oo,{{'1.5SMC350CA ###','1.5SMC350CA'},...
                   ...
                   {},...
                   {'CNR05D361  (DISK MOV)', 'CNR05D361'},...
                   {'CNR05D391! (DISK MOV CNR)', 'CNR05D391'},...
                   {'V360ZA05P  (DISK MOV)', 'V360ZA05P'},...
                   {'V390ZA05P! (DISK MOV LittleFuse)', 'V390ZA05P'},...
                   },{});
end
...
function oo = X2Menu(o)                                                
   ...
   oo = mitem(o,'X2 Capacitor',{},'Cp');
        choice(oo,{{'Off',0},{},{'47nF',47e-9},{'68nF',68e-9},...
                   {'100nF',100e-9},{'150nF',150e-9},...
...
%  o = set(o,'simu.dt',2e-9);
   dt = opt(o,{'simu.dt',2});          % simulation interval [ns]
   o = set(o,'simu.dt',dt*1e-9);
