function oo = write(o,varargin)        % Write BLUCO Object To File
%
% WRITE   Write driver to write a BLUCO object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: BLUCO, EXPORT
%
...
%==========================================================================
% Data Write Driver for Bluco Stuff
%==========================================================================
