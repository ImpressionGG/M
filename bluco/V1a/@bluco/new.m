function oo = new(o,varargin)          % BLUCO New Method              
%
% NEW   New BLUCO object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(bluco,'Simple')    % some simple data
%           o = new(bluco,'Wave')      % some wave data
%           o = new(bluco,'Beat')      % some beat data
%
%       See also: BLUCO, PLOT, ANALYSIS, STUDY
%
