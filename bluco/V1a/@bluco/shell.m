function oo = shell(o,varargin)        % BLUCO shell
...
function o = Init(o)                   % Init Object
   ...
   o = provide(o,'par.title','Bluco Shell');
   o = provide(o,'par.comment',{'Playing around with BLUCO objects'});
...
function oo = Import(o)                % Import Menu Items
   ...
   ooo = mitem(oo,'Bluco');
   oooo = mitem(ooo,'Log Data (.dat)',{@ImportCb,'ReadGenDat','.dat',@bluco});
   return
...
function oo = Export(o)                % Export Menu Items
   ...
   ooo = mitem(oo,'Bluco');
   oooo = mitem(ooo,'Log Data (.dat)',{@ExportCb,'WriteGenDat','.dat',@bluco});
   return
...
function oo = View(o)                  % View Menu
   ...
   plugin(o,'bluco/shell/View');       % plug point
end
...
function oo = Plot(o)                  % Plot Menu
   ...
   plugin(o,'bluco/shell/Plot');       % plug point
end
...
function oo = Analyse(o)               % Analyse Menu
   ...
   plugin(o,'bluco/shell/Analyse');    % plug point
end
...
function oo = Mosfet(o)                % Mosfet Menu
   oo = mhead(o,'MOSFET');             % add roll down header menu item
   dynamic(oo);                        % make this a dynamic menu
   ooo = mosfet(oo,'Menu');             % setup study menu

   plugin(o,'bluco/shell/Study');      % plug point
end
...
function oo = Info(o)                  % Info Menu
   ...
   oooo = mitem(ooo,['Bluco Class: Version ',version(bluco)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit bluco/version');

   plugin(o,'bluco/shell/Info');       % plug point
end
