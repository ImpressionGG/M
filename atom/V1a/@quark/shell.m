function oo = shell(o,varargin)        % Tiny Shell for QUARK Class  
% 
% SHELL  Open new figure and setup menu for a QUARK object
%      
%           o = quark      % create a QUARK object
%           shell(o)         % open a tiny QUARK shell
%
%        Code lines: 36
%
%        See also: QUARK
...
function oo = Animation(o)             % File Menu                     
   ...
   ooo = mitem(oo,'Red Quark Shit',  {@Shit,'r',3});
   ooo = mitem(oo,'Green Quark Shit',{@Shit,'g',2});
   ooo = mitem(oo,'Blue Quark Shit', {@Shit,'b',5});
end
...
function o = Shit(o)                   % Shit Animation Callback        
   ...
   animate(gluon,d.X,d.Y,d.Z,col,rough);
end
