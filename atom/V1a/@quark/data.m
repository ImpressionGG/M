...
%    See also: QUARK, PROP
%
   section = 'dat';    % here we store settings
   switch nargin
      case 1
         d = prop(o,section);
         if (nargout == 0)
      ...
      case 2
         ...
         elseif (isa(tag,'double'))
            ...
            if (idx == 0)
               ...
               return
            elseif isinf(idx)
               if iscell(o.dat) || isempty(o.dat)
                  o = length(o.dat);   % return length of list
               else
            ...
            if (idx >= 1 && idx <= length(o.dat))
               varargout{1} = o.dat{idx};
            else
               varargout{1} = [];
            end
         else
      ...
      case 3
         ...
         elseif (nargout <= 1) && isa(tag,'double')
            ...
            varargout{1} = o;
         elseif (nargout == 2)
            varargout{1} = dat(o,tag);
            varargout{2} = dat(o,value);
         else
