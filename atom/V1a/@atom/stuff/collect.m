...
%       table0 = {{@read,'caramel','PackageDrv','.pkg'},...
%                 {@read,'caramel','UniLogDrv', '.log'}};
...
%       collect(o,{})                  % reset collection config
%
%       table1 = {{@read,'caramel','PackageDrv','.pkg'},...
%                 {@read,'caramel','UniLogDrv', '.log'}};
%       collect(o,{'pln','smp'},table1); 
%
%       table2 = {{@read,'caramel','PackageDrv','.pkg'},...
%                 {@read,'caramel','UniLogDrv', '.log'}};
%                 {@basis,'caramel','VibTxtDrv','.txt'}},...
%       collect(o,{'vib'},table2); 
%
%       table3 = {{@read,'caramel','PackageDrv','.pkg'},...
%                 {@read,'caramel','UniLogDrv', '.log'}};
%                 {@basis,'caramel','BmcTxtDrv','.txt'}},...
%                 {@basis,'caramel','BmcPbiDrv','.pbi'}},...
%       collect(o,{'bmc'},table3); 
%
%    See also: CARAMEL, IMPORT
%
