...
%
%    Check if object is a trace type CARAMEL object, or setup as a
...
%
%    CARAMEL trace data can be in stream type form (sequence of scalars)
%    The data can be indexed by index numbers or by time stamps. CARAMEL
%    stream type traces has a specific data representation and several
%    CARAMEL methods are specialized on trace typed data.
%
%    See also: CARAMEL, LOG, PLOT, LABEL, CONFIG, CATEGORY, SUBPLOT
%
