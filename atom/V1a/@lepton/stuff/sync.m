...
%
%    If '[Carabase]' is not contained in the filepath then the whole function
%    call will be ignored. SYNC returns a list of filepathes to the direc-
%    tories which have been modified.
%
%    Remark: the method SYNC will be called implicitely by carabase/save
%    method
%
%    Code lines: 43
%
%    See also: CARABASE, SAVE, MOUNTABLE
%
...
%
% coming to this point means that directory '[Carabase]' has not been found
