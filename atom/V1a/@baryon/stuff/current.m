...
%
%       oo = current(carabao)          % get current trace object
%       [oo,index] = current(carabao)  % get also current index
%       o = current(carabao,oo);       % update current object
%
...
%       object is replaced by shell object (o=pull(carabao)) and proceed
%       with 1) or 2).
%
