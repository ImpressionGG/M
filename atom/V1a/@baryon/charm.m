...
%
%       charm(carabao,inf)             % process CHARM callback
%
%    See also: CARABAO, MENU, MITEM, CHOICE, CHECK, DEFAULT
%
   %CHM = 'charm(carabao,inf);'; 
%
% One input arg
...
% a) charm(carabao,inf);               % charm callback (edit value!)
%
...
% a) charm(oo,'refresh(carabao)') % charm functionality (with refresh)
