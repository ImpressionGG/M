function oo = write(o,varargin)        % Write CORAZON Object To File  
%
...
%
   [gamma,oo] = manage(o,varargin,@Error,@WriteSmpDat,...
                       @WriteLogLog,@WriteGenDat,@WritePkgPkg,...
                       @WriteStuffTxt,@Type,@Param,@Header,@Data);
   oo = gamma(oo);
end
...
%==========================================================================
% Data Write Driver for Corazon Stuff
%==========================================================================
...
function oo = WritePkgPkg(o)           % Export Driver For .pkg File   
   ...
   if ~isempty(oo.data)
      fprintf(fid,'%%\n%% Data\n%%\n');
      oo = write(oo,'Header',fid);
      oo = write(oo,'Data',fid);
   end
...
function o = Data(o)                   % Write Data to File            
   ...
   if ~isempty(o.data) && isempty(symbols)
      symbols = fields(o.data);
   end
