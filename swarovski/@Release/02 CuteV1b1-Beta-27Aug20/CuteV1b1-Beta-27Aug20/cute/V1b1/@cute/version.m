...
%   to the list of their child objects. If a package is imported then
%   only the files listed as children are imported
% 
%--------------------------------------------------------------------------
%
% Roadmap
...
% - evolution plot for velocity and elongation, including settings for
%   closeup
