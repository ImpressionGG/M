...
%       o = category(o,1,[0 0],[0 0],'�');     % setup category 1
%       o = category(o,1,[],[],'�');           % same as above
%       o = category(o,2,[-3 3],[-4 4],'�');   % setup category 2
%
...
%
%    See also: CORDOBA, CONFIG, SUBPLOT, TYPE
%
...
% b) o = category(o,1,[0 0],[0 0],'�');     % setup category 1
% c) o = category(o,1,[],[],'�');           % same as above
% d) o = category(o,2,[-3 3],[-4 4],'�');   % setup category 2
%
   while (nargin > 2)                                                  
      if isempty(spec)
         spec = [0 0];
