function oo = write(o,varargin)        % Write CUTE Object To File
%
% WRITE   Write driver to write a CUTE object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: CUTE, EXPORT
%
...
%==========================================================================
% Data Write Driver for Cute Stuff
%==========================================================================
