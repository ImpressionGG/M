function scale = oscale(o)
%
% OSCALE  Retrieve omega scale acoording to current settings of normalized
%         time
%
%            scale = oscale(o)         % retrieve omega scale
%
%         Example 1
%
%            [L0,f0] = cook(o,'L0,f0')
%            diagram(o,'Bode','',L0,111)
%            Ljw = fqr(L0,2*pi*f0*oscale)   % normalize circular frequency
%            semilogx(2*pi*f0,20*log10(abs(Ljw)),'r')
%
%         Example 2
%
%            
...
%         See also: SPM
%
   scale = opt(o,{'brew.T0',1});       % equals normalization time constant   
end
