function [out1,out2,out3,out4] = cons1(o,x,t)
%
% CONS1  Constrained system model, version 1
%
...
%
%        See also: CUT, CONS1, HOGA1, HOGA2, HEUN, SODE
%
   ...
   vc = p.vc;                % [m/s]  cutting speed
   vs = p.vs;                % [m/s]  seek speed
