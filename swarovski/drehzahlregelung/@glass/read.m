function oo = read(o,varargin)         % Read GLASS Object From File
%
% READ   Read a GLASS object from file.
%
%             oo = read(o,driver,path)
%
%             oo = read(o,'ReadGlassLog',path)   % read .log data
%             oo = read(o,'ReadGlassDat',path)   % read .dat data
%
%          See also: GLASS, IMPORT, EXPORT, WRITE
%
   [gamma,oo] = manage(o,varargin,@Error,@ReadGlassLog,@ReadGlassDat);
   oo = gamma(oo);
...
%==========================================================================
% Read Driver for Glass Data
%==========================================================================

function oo = ReadGlassLog(o)         % Read Driver for Glass .log   
   path = arg(o,1);
   [x,y,par] = Read(path);             % read data into variables x,y,par
   
   oo = glass('log');                  % create 'log' typed GLASS object
