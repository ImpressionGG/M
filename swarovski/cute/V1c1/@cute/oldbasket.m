...
function tags = BasketTags(o)
   tags = {'station','damping','kappl','lage','vcut','vseek'};
end
...
function oo = PkgMenu(o)               % Setup Basket Menu @ Package   
   ...
   for (i=1:length(tags))
      tag = tags{i};
      %basket = OldAddSpecifics(o,oo,basket,tag);
      values = get(oo,tag);
...
function basket = OldAddSpecifics(o,oo,basket,tag)
