function oo = new(o,varargin)          % CUTE New Method              
%
% NEW   New CUTE object
%
%           oo = new(o,'Menu')         % menu setup
%
%           o = new(cute,'Simple')    % some simple data
%           o = new(cute,'Wave')      % some wave data
%           o = new(cute,'Beat')      % some beat data
%
%       See also: CUTE, PLOT, ANALYSIS, STUDY
%
