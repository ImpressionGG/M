function oo = read(o,varargin)         % Read PREDICT Object From File
%
% READ   Read a PREDICT object from file.
%
%             oo = read(o,driver,path)
%
%             oo = read(o,'ReadPredictLog',path)   % read .log data
%             oo = read(o,'ReadPredictDat',path)   % read .dat data
%
%          See also: PREDICT, IMPORT, EXPORT, WRITE
%
   [gamma,oo] = manage(o,varargin,@Error,@ReadPredictLog,@ReadPredictDat);
   oo = gamma(oo);
...
%==========================================================================
% Read Driver for Predict Data
%==========================================================================

function oo = ReadPredictLog(o)         % Read Driver for Predict .log   
   path = arg(o,1);
   [x,y,par] = Read(path);             % read data into variables x,y,par
   
   oo = predict('log');                  % create 'log' typed PREDICT object
