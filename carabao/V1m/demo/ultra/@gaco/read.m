function oo = read(o,varargin)         % Read GACO Object From File
%
% READ   Read a GACO object from file.
%
%             oo = read(o,driver,path)
%
%             oo = read(o,'ReadGacoLog',path)   % read .log data
%             oo = read(o,'ReadGacoDat',path)   % read .dat data
%
%          See also: GACO, IMPORT, EXPORT, WRITE
%
   [gamma,oo] = manage(o,varargin,@Error,@ReadGacoLog,@ReadGacoDat);
   oo = gamma(oo);
...
%==========================================================================
% Read Driver for Gaco Data
%==========================================================================

function oo = ReadGacoLog(o)         % Read Driver for Gaco .log   
   path = arg(o,1);
   [x,y,par] = Read(path);             % read data into variables x,y,par
   
   oo = gaco('log');                  % create 'log' typed GACO object
