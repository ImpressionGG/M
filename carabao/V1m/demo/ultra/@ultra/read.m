function oo = read(o,varargin)         % Read ULTRA Object From File
%
% READ   Read a ULTRA object from file.
%
%             oo = read(o,driver,path)
%
%             oo = read(o,'ReadUltraLog',path)   % read .log data
%             oo = read(o,'ReadUltraDat',path)   % read .dat data
%
%          See also: ULTRA, IMPORT, EXPORT, WRITE
%
   [gamma,oo] = manage(o,varargin,@Error,@ReadUltraLog,@ReadUltraDat);
   oo = gamma(oo);
...
%==========================================================================
% Read Driver for Ultra Data
%==========================================================================

function oo = ReadUltraLog(o)         % Read Driver for Ultra .log   
   path = arg(o,1);
   [x,y,par] = Read(path);             % read data into variables x,y,par
   
   oo = ultra('log');                  % create 'log' typed ULTRA object
