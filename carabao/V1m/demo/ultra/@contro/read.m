function oo = read(o,varargin)         % Read CONTROL Object From File
%
% READ   Read a CONTROL object from file.
%
%             oo = read(o,driver,path)
%
%             oo = read(o,'ReadControlLog',path)   % read .log data
%             oo = read(o,'ReadControlDat',path)   % read .dat data
%
%          See also: CONTROL, IMPORT, EXPORT, WRITE
%
   [gamma,oo] = manage(o,varargin,@Error,@ReadControlLog,@ReadControlDat);
   oo = gamma(oo);
...
%==========================================================================
% Read Driver for Control Data
%==========================================================================

function oo = ReadControlLog(o)         % Read Driver for Control .log   
   path = arg(o,1);
   [x,y,par] = Read(path);             % read data into variables x,y,par
   
   oo = control('log');                  % create 'log' typed CONTROL object
