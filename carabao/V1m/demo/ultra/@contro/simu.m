...
function o = Setup(o)                  % Setup Simulation Menu         
   ...
   ooo = mitem(oo,'Plant');
   oooo = mitem(ooo,'Transfer Function',{@PlantTrf});
   oooo = mitem(ooo,'Step Response',{@PlantStep});
   oooo = mitem(ooo,'Bode Plot',{@PlantBode});
   ooo = mitem(oo,'-');
...
function o = PlantTrf(o)
   o = Plant(o);
   dsp(o);
end
function o = PlantStep(o)
   o = Plant(o);
   step(o);
end
function o = PlantBode(o)
   o = Plant(o);
   bode(o);
end
...
%
% SIMU2  Simulation data is stored in a CONTROL object of type 'trigo',
...
%
   oo = control('trigo');                % create a 'trigo' typed object
...
%
% SIMU3  Simulation data is stored in a CONTROL object of type 'expo',
%        stored into clipboard for potential paste and plotted. If
%        pasted (with Edit>Paste) object can be further analyzed using
%        'Plot>Stream Plot'.
%        Use 'Plot>Stream Plot X', 'Plot>Stream Plot Y' or 'Plot/Scatter
...
%        while switching signal configurations in View/Signal menu.
%
   oo = control('expo');                 % create an 'expo' typed object
   oo = log(oo,'t','x','y');           % setup a data log object
...
%
% SIMU4  Repeated simulation data is stored in a CONTROL object of type
...
%        while switching signal configurations in View/Signal menu.
%
   oo = control('trigo');                % create an 'trigo' typed object
   oo = log(oo,'t','x','y');           % setup a data log object
