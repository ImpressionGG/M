function oo = boost(o,varargin)        % Boost Menu                    
%
% BOOST   Manage Boost menu
%
...
function o = Setup(o)                  % Setup Boost Menu              
   Register(o);
   
   setting(o,{'boost.zoom',false});
...
function o = Signal(o)                 % Boost Specific Signal Menu    
%
...
function oo = ConverterMenu(o)         % Submenu Converter             
   setting(o,{'boost.mode'},'PhaseCutRConverter');
   setting(o,{'boost.repeats'},1);           

   oo = mitem(o,'Converter',{},'boost.mode');
...
function oo = Simulation(o,mode)       % Converter Type Simulation     
   ...
   if (nargin == 2)
      choice(o,'boost.mode',mode);
      o = pull(o);                     % refresh object
   end
   mode = opt(o,'boost.mode');
   switch mode
...
function o = SimuB1(o)                 % Boost B1: Buck Oscillator     
%
...
function o = SimuB2(o)                 % Boost B2: Buck Converter      
%
...
function o = StudyC1(o)                % Boost C1: Cuk Principle       
%
...
function o = StudyC2(o)                % Boost C2: Cuk Converter       
%
...
function o = StudyH1(o)                % Boost H1: Capacitor Load      
%
...
function o = StudyH2(o)                % Boost H2: Huck Oscillation    
%
...
function o = StudyH3(o)                % Boost H3: Huck Oscillations   
%
...
function o = StudyH4(o)                % Boost H4: Huck Pump           
%
% STUDYH4 Huck Pump
%
   oo = huck('huck');                   % create a 'huck' typed object
...
function o = StudyH5(o)                % Boost H5: Huck Converter      
%
...
function o = StudyPR1(o)               % Phase Cut R-Converter Boost 1 
...
function o = StudyPR2(o)               % Phase Cut R-Converter Boost 2 
...
function Schematics(o,imagefile,title) % Show Schematics               
   setting(o,'boost.schematics',imagefile);
