...
%
% SIMU2  Simulation data is stored in a FACEUP object of type 'trigo',
...
%
   oo = faceup('trigo');                % create a 'trigo' typed object
...
%
% SIMU3  Simulation data is stored in a FACEUP object of type 'expo',
%        stored into clipboard for potential paste and plotted. If
%        pasted (with Edit>Paste) object can be further analyzed using
%        'Plot>Stream Plot'.
%        Use 'Plot>Stream Plot X', 'Plot>Stream Plot Y' or 'Plot/Scatter
...
%        while switching signal configurations in View/Signal menu.
%
   oo = faceup('expo');                 % create an 'expo' typed object
   oo = log(oo,'t','x','y');           % setup a data log object
...
%
% SIMU4  Repeated simulation data is stored in a FACEUP object of type
...
%        while switching signal configurations in View/Signal menu.
%
   oo = faceup('trigo');                % create an 'trigo' typed object
   oo = log(oo,'t','x','y');           % setup a data log object
