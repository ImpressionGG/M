function oo = shell(o,varargin)        % CARAMEL shell                 
%
% SHELL   CARAMEL Shell
%
...
function o = Init(o)                   % Init Object                   
   o = menu(o,'Default');              % provide CARAMEL defaults
...
function o = Register(o)               % Register Plugins              
   ...
   plugin(o,'caramel/shell/Register');% plug point
   rebuild(o);
end
...
function oo = File(o)                  % File Menu                     
   ...
   plugin(oo,'caramel/shell/File');    % plug point
end
function oo = New(o)                   % New Menu Items                
   ...
   plugin(oo,'caramel/shell/New');     % plug point
end
function oo = Import(o)                % Import Menu Items             
   ...
   plugin(oo,'caramel/shell/Import');  % plug point
   return
...
function oo = Export(o)                % Export Menu Items             
   ...
   plugin(oo,'caramel/shell/Export');  % plug point
   return
...
function oo = Collect(o)               % Configure Collection          
   ...
   plugin(o,'caramel/shell/Collect');  % plug point
...
function oo = Edit(o)                  % Edit Menu                     
   ...
   plugin(oo,'caramel/shell/Edit');    % plug point
end
...
function oo = View(o)                  % View Menu                     
   ...
   plugin(ooo,'caramel/shell/Style');  % plug point
   ooo = wrap(oo,'Signal');            % Wrap Signal Menu
   plugin(oo,'caramel/shell/View');    % plug point
end
...
%
   ...
   plugin(oo,'caramel/shell/Signal');  % plug point
...
function oo = Select(o)                % Select Menu                   
   ...
   plugin(oo,'caramel/shell/Select');  % plug point
end
...
function oo = Plot(o)                  % Plot Menu                     
   if isequal(o.type,'weird')
      ...
      ooo = menu(oo,'Plot');           % delegate to menu@caramel>Plot
   end
   plugin(oo,'caramel/shell/Plot');    % plug point
end
...
function oo = Analysis(o)              % Analysis Menu                 
   ...
   plugin(oo,'caramel/shell/Analysis');% plug point
end
...
function oo = Study(o)                 % Study Menu                    
   ...
   plugin(oo,'caramel/shell/Study');   % plug point
end
...
function oo = Plugin(o)                % Plugin Menu                   
   ...
   oo = plugin(oo,'caramel/shell/Plugin');
end
...
function oo = Gallery(o)               % Gallery Menu                  
   ...
   plugin(oo,'caramel/shell/Gallery'); % plug point
end
...
function oo = Info(o)                  % Info Menu                     
   ...
   oooo = mitem(ooo,['Caramel Class: Version ',version(caramel)]);
   ooooo = mitem(oooo,'Edit Release Notes','edit espresso/version');
   plugin(oo,'caramel/shell/Info');    % plug point
end
...
function oo = Figure(o)                % Figure Menu                   
   ...
   plugin(oo,'caramel/shell/Figure');  % plug point
end
