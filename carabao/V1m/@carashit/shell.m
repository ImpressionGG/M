function oo = shell(o,varargin)        % Tiny Shell for CARASHIT Class 
% 
% SHELL  Open new figure and setup menu for a CARASHIT object
%      
%           o = carashit     % create a CARASHIT object
%           shell(o)         % open a tiny CARASHIT shell
%
%        Code lines: 36
%
%        See also: CARASHIT
...
function list = Dynamic(o)             % List of Dynamic Carashit Menus
   list = {'Plot'};
end

function o = Init(o)                   % Init Shell         
   if isempty(get(o,'title'))
      o = set(o,'title','Carashit Object');
...
function oo = Plot(o)                  % Plot Menu                
   ...
   ooo = mitem(oo,'Green Carabao Shit',{@Shit,'g',1});
