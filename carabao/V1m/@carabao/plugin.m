...
%
%          Example 1: carabao/shell/Info provides a plugin point
%
%             function oo = Info(o)    % carabao/shell/Info function
%                oo = menu(o,'Info');  % add Info menu
%                key = 'carabao/menu/Info';
...
%                plugin(o,'carabao/menu/Info','xyplot','Info');
%             end
%
%          See also: CARABAO
%
