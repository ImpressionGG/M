...
%    and forwards to Carabao style callback.
%
%           oo = master(obj,evt,arg1,arg2,...)
%
%        See also: CARABULL
%
   bo = construct(carabull,tag);       % base object for pull method
...
%    end
   ...
   busy(carabull);                     % change mouse pointer -> busy
   oo = call(o,cblist,bo,tag);         % invoke master callback
   ready(carabull);                    % change mouse pointer -> ready
end