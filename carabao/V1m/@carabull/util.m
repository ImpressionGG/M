...
%
%       util(carabull);      % setup: either, iif, is, cuo, sho, ticn, tocn
%    
...
function Shorthands(o)                 % Setup some short hands
   evalin('base','iif=@carabull.iif;');
   evalin('base','is=@carabull.is;');
   evalin('base','either=@carabull.either;');
%  evalin('base','cuo=@carabull.cuo;');
%  evalin('base','sho=@carabull.sho;');
   evalin('base','ticn=@carabull.ticn;');
   evalin('base','tocn=@carabull.tocn;');
end
