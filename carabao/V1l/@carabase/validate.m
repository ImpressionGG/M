...
%       query.serial = {'95088414253'};   % list of serial numbers
%       query.datenum = now;              % date/time stamp
%       query.class = 'pbi'               % PBI class
%       query.author = 'emp001609'        % Author short cut or name
%
%       o = carabase(query);                % construct CARABASE object
%       valid = validate(o);              % valid = 1
%
%    Remarks: the CARABASE constructor implicitely validates the internal
%    query structure at the end of each construction process, unless the
%    carabase object is generic (empty query structure).
%
%    Performance: 60 µs for validation of a query structure
%
%    Code lines: 44
%
%    See also: CARABASE, QUERY
%
