function oo = shell(o,varargin)        % Tiny Shell for CARABAO Class  
% 
% SHELL   Open new figure and setup menu for a CARABAO object
%      
%            o = carabao     % create a CARABAO object
%            shell(o)        % open a CARABAO shell
%
...
function o = Init(o)                   % Init Object                   
   if isempty(get(o,'title')) && container(o)
      ...
      o = set(o,'title','Carabao Shell');
      o = set(o,'comment',{'a dynamic shell for Carabao objects'});
   end
...
function oo = Import(o)                % Import Menu Items             
   ...
   plugin(oo,'carabao/shell/Import');  % plug point
   return
...
function oo = Export(o)                % Export Menu Items             
   ...
   plugin(oo,'carabao/shell/Export');  % plug point
   return
...
function oo = Edit(o)                  % Edit Menu                     
   ...
   plugin(oo,'carabao/shell/Edit');    % plug point
end
...
function oo = Select(o)                % Select Menu                   
   ...
   plugin(oo,'carabao/shell/Select');  % plug point
end
...
function oo = Plot(o)                  % Plot Menu                     
   ...
   check(ooo,'');
   plugin(oo,'carabao/shell/Plot');    % plug point
   return
...
%
   ...
   dynamic(oo);                        % make this a dynamic menu
   plugin(oo,'carabao/shell/Animation');
end
...
%
   ...
   plugin(oo,'carabao/shell/Analysis');% plug point
end
...
function oo = Plugin(o)                % Plugin Menu                   
   ...
   oo = plugin(oo,'carabao/shell/Plugin');
end
...
function oo = Gallery(o)               % Gallery Menu                  
   ...
   plugin(oo,'carabao/shell/Gallery'); % plug point
end
...
function oo = Info(o)                  % Info Menu                     
   ...
   plugin(oo,'carabao/shell/Info');    % plug point
end
...
function oo = Figure(o)                % Figure Menu                   
   ...
   plugin(oo,'carabao/shell/Figure');  % plug point
end
