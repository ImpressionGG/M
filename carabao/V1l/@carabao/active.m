...
%
%          Note that caramel/menu/PlotCb clears the active type! This
%          forces next use of GRAPH to activate active type including
%          proper configuration setup and Signal menu build.
%
%    See also: CARAMEL, CHANGE, GRAPH, CONTROL
%
...
%          CARAMEl (or derived) object during plotting and analysis
%       b) View/Config: allows to view and change details of a shell
%          provided configuration
%
% 2) All graphics refering to signals of a CARAMEL (or derived) object 
