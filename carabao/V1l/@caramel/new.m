...
%
% NEW   Create new CARAMEL or derived CARAMEL object. Use options
...
%
   ...
   oo = caramel('pkg');                % construct CARAMEL package object
...
function oo = Simple(o)                % New Simple Object             
   ...
   p = 70 + p.*(1+0.2*t/max(t));       % biased & time variant
      ...
      % create a caramel object with t,x,y,p, ux & uy
...
function oo = Plain(o)                 % New Plain Object              
   ...
   p = p.*(1+0.2*t/max(t));            % time variant
      ...
      % make a caramel object with t,x,y & p
