function oo = read(o,varargin)         % Read MATCHA Object From File
%
% READ   Read a MATCHA object from file.
%
%             oo = read(o,driver,path)
%
%             oo = read(o,'ReadMatchaLog',path)   % read .log data
%             oo = read(o,'ReadMatchaDat',path)   % read .dat data
%
%          See also: MATCHA, IMPORT, EXPORT, WRITE
%
   [gamma,oo] = manage(o,varargin,@Error,@ReadMatchaLog,@ReadMatchaDat);
   oo = gamma(oo);
...
%==========================================================================
% Read Driver for Matcha Data
%==========================================================================

function oo = ReadMatchaLog(o)         % Read Driver for Matcha .log   
   path = arg(o,1);
   [x,y,par] = Read(path);             % read data into variables x,y,par
   
   oo = matcha('log');                  % create 'log' typed MATCHA object
