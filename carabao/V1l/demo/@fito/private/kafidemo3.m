...
Q = diag([1, 1])/1000;
   ...
   title(sprintf('Time invariant extended Kalman Filter - signal: std(w) = %g, Suppresion: %g (%g)',stdw,suppression,suppression0));
   xlabel(sprintf('Dynamic Kalman Filter, estimation error: std(f) = %g (%g))',stdf,stdf0));
