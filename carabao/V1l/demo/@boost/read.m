function oo = read(o,varargin)         % Read BOOST Object From File
%
% READ   Read a BOOST object from file.
%
%             oo = read(o,driver,path)
%
%             oo = read(o,'ReadBoostLog',path)   % read .log data
%             oo = read(o,'ReadBoostDat',path)   % read .dat data
%
%          See also: BOOST, IMPORT, EXPORT, WRITE
%
   [gamma,oo] = manage(o,varargin,@Error,@ReadBoostLog,@ReadBoostDat);
   oo = gamma(oo);
...
%==========================================================================
% Read Driver for Boost Data
%==========================================================================

function oo = ReadBoostLog(o)         % Read Driver for Boost .log   
   path = arg(o,1);
   [x,y,par] = Read(path);             % read data into variables x,y,par
   
   oo = boost('log');                  % create 'log' typed BOOST object
