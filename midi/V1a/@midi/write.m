function oo = write(o,varargin)        % Write MIDI Object To File
%
% WRITE   Write driver to write a MIDI object to file.
%
%             oo = write(o,'WriteStuffTxt',path)
%
%          See also: MIDI, EXPORT
%
...
%==========================================================================
% Data Write Driver for Midi Stuff
%==========================================================================
